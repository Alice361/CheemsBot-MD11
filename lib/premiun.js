...
//YouTube: @Joker_Apocalypse
//Instagram: seijuro.lionel
//Telegram: t.me/xeonbotinc
//GitHub: @Joker15-tech
//WhatsApp: +2250500107362
//want more free bot scripts? subscribe to my youtube channel: https://youtube.com/@Joker_Apocalypse
...
const expiredPremiumCheck = (JokerBotInc, msg, _dir) => {
	setInterval(() => {
		let position = null;
		Object.keys(_dir).forEach((i) => {
		...
		if (position !== null) {
			...
			fs.writeFileSync("./src/data/role/premium.json", JSON.stringify(_dir));
			idny ? JokerBotInc.sendMessage(idny, { text: "Your premium has run out, please buy again." }) : "";
			idny = false;
		}
	}, 1000);
};
